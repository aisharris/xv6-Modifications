...
main(int argc, char *argv[]) {
  ...
  6e:	7d650513          	addi	a0,a0,2006 # 840 <malloc+0xec>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ca:	3a2c8c93          	addi	s9,s9,930 # 868 <malloc+0x114>
 ...
 4d8:	3ecb8b93          	addi	s7,s7,1004 # 8c0 <digits>
 ...
 5fe:	26698993          	addi	s3,s3,614 # 860 <malloc+0x10c>
        while(*s != 0){
 602:	85ee                	mv	a1,s11
