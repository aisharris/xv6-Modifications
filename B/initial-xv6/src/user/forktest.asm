...
forktest(void)
{
  ...
  3e:	42650513          	addi	a0,a0,1062 # 460 <setpriority+0xc>
  ...
  68:	40c50513          	addi	a0,a0,1036 # 470 <setpriority+0x1c>
  ...
  b8:	40c50513          	addi	a0,a0,1036 # 4c0 <setpriority+0x6c>
  ...
  d4:	3c050513          	addi	a0,a0,960 # 490 <setpriority+0x3c>
  ...
  ee:	3be50513          	addi	a0,a0,958 # 4a8 <setpriority+0x54>
